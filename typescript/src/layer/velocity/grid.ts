...
export default class Grid {
    ...
    get (λ: number, φ: number): Vector {
        ...
        if (iλ>=0 && iφ>=0 && iλ<this.width && iφ<this.height) {
          let g00 = this.data[this.width-iλ + iφ * this.width];
          let g10 = this.data[this.width-jλ + iφ * this.width];

          if (this.isValue(g00) && this.isValue(g10)){
            let g01 = this.data[this.width-iλ + jφ * this.width];
            let g11 = this.data[this.width-jλ + jφ * this.width];
