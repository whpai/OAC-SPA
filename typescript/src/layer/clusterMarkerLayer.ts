                    ...
                    let dom = new Vue({
                        render: h => h(
                            ...
                            [
                                ...
                                h("div", `鹽度: ${station.SALINITY || "--"} psu`),
                                h("div", `PH: ${station.Str_pH || "--"}`),
                                h("div", `溶氧量(電極法): ${station.Str_DO || "--"} mg/L`),
                                h("div", `葉綠素a: ${station.Str_Chl_A || "--"} μg/L`),

                                h("div", `鎘: ${station.Str_Cd || "--"} mg/L`),
                                h("div", `鉻: ${station.Str_Cr || "--"} mg/L`),
                                h("div", `銅: ${station.Str_Cu || "--"} mg/L`),
                                h("div", `鋅: ${station.Str_Zn || "--"} mg/L`),
                                h("div", `鉛: ${station.Str_Pb || "--"} mg/L`),
                                h("div", `汞: ${station.Str_Hg || "--"} mg/L`),
